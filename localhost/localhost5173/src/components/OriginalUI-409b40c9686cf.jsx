    ...
    <div className="mt-4 md:mt-8 mb-10 md:mb-24 2xl:max-w-7xl px-4 md:px-8 mx-auto">
      ...
      >
        <div className="relative w-full z-10">
          ...
          >
            <div
              className="flex absolute inset-0 top-[25%] -translate-y-1/2 left-1/4 right-1/4 z-51 justify-center mask-l-from-50% mask-r-from-50%"
            >
              <div className="h-full w-full overflow-hidden relative">
                <div
                  className="absolute z-1 top-1/2 -translate-y-1/2 flex gap-2 items-center animate-infinite-slider"
                >
                  <div
                    className="relative w-[6.25rem] h-[6.25rem] shrink-0"
                ...
                <div
                  className="absolute left-0 right-0 h-[200px] w-[280px] bg-[white] mx-auto top-[114px]"
                ></div>
              </div>
            </div>
            <div
              className="relative top-[20px] flex items-center justify-end left-1/2 -translate-x-1/2 bg-black h-[26px] w-[100px] rounded-full z-5"
            >
              <div
                className="h-[16px] bg-[radial-gradient(50%_50%_at_50%_50%,_var(--color-white-4,_rgba(255,_255,_255,_0.04))_72%,_var(--color-white-16,_rgba(255,_255,_255,_0.16))_100%)] w-[16px] mr-[5px] rounded-full absolute right-0"
              ></div>
            </div>
            <div
              className="h-full top-[10px] bg-white mx-auto w-[280px] rounded-tr-[36px] rounded-tl-[36px] shadow-xl absolute inset-0 z-4"
            ></div>
            <div
              className="h-[600px] mx-auto w-[300px] bg-[linear-gradient(180deg,_rgba(88,_88,_88,_0.24)_0%,_rgba(255,_255,_255,_0.24)_100%)] rounded-[38px] shadow-xl absolute inset-0 z-3"
            ></div>
            <div
              className="absolute h-[400px] w-[280px] top-[10px] rounded-[36px] mx-auto bg-[rgb(21, 21, 21)] flex items-end z-4 justify-center inset-0 left-1 right-1"
            ></div>
            <div
              className="absolute flex items-end z-100 justify-center inset-0 inset-x-1 top-40"
            ...
            >
              <img
                ...
                style={{"color":"transparent"}}
                srcset="
                  /assets/images/how-to/slider/product-5-details.png 1x,
                  /assets/images/how-to/slider/product-5-details.png 2x
                "
                src="/assets/images/how-to/slider/product-5-details.png"
              />
            </div>
          </div>
        </div>
